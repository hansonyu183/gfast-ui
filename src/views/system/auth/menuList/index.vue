    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType != '2'" label="显示状态">
              <el-radio-group v-model="form.visible">
                <el-radio v-for="dict in visibleOptions.values" :key="dict.key" :label="dict.key">{{
                  dict.value
                }}</el-radio>
              </el-radio-group>
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType != '2'" label="菜单状态">
              <el-radio-group v-model="form.status">
                <el-radio v-for="dict in statusOptions.values" :key="dict.key" :label="dict.key">{{
                  dict.value
                }}</el-radio>
              </el-radio-group>
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType == '1'" label="路由传参">
              <el-radio-group v-model="form.props">
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType == '3'" label="重定向" prop="redirect">
