<template>
  <div>
    <el-dialog v-bind="$attrs" v-on="$listeners" @open="onOpen" @close="onClose" :visible="visible">
      <template v-slot:title>
        <el-row type="flex" justify="start" align="top" gutter="1">
          <el-col :span="20">
            <el-row type="flex" justify="start" align="top" gutter="1">
              <el-tooltip class="item" effect="dark" content="前单" placement="top-start">
                <el-button icon="el-icon-arrow-left" @click="onPre"></el-button>
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="后单" placement="top-start">
                <el-button icon="el-icon-arrow-right" @click="onNext"></el-button>
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="菜单" placement="top-start">
                <el-button icon="el-icon-caret-bottom" @click="onOpenMenu"></el-button>
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="打印" placement="top-start">
                <el-button type="info" icon="el-icon-printer" @click="onPrint"></el-button>
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="新增" placement="top-start">
                <el-button type="primary" icon="el-icon-plus" @click="onAddNew"></el-button>
              </el-tooltip>
              <el-tooltip
                ...
                placement="top-start"
              >
                <el-button type="success" :icon="vouState.nextIcon" @click="onGoNext"></el-button>
              </el-tooltip>
              <el-tooltip
                ...
                placement="top-start"
              >
                <el-button type="warning" :icon="vouState.backIcon" @click="onGoback"></el-button>
              </el-tooltip>
            </el-row>
          </el-col>
          <el-col :span="4">
      ...
      <template v-slot:footer>
        <el-form ref="elForm" :model="vouData" :rules="rules" label-width="100px">
